...
/**
 * DTO de exemplo para demonstracao de validacao de entrada e respostas Problem Details. Nao
 * representa um caso de uso real de dominio; sera removido ou substituido quando endpoints de
 * dominio forem implementados.
 */
